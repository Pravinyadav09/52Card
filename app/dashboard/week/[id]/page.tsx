...
import {
    ...
    MessageCircle, Play, Video, Share2,
    Copy, ExternalLink, Zap, Clock,
...
export default function WeekDetailPage() {
    ...
    const weekData = MOCK_WEEKS.find(w => w.id === weekId) || MOCK_WEEKS[0];
    ...
    return (
        <div className="space-y-8 animate-in slide-in-from-right-4 duration-700 max-w-6xl mx-auto pb-20">
                ...
                <div className="flex-1 space-y-8">
                    ...
                    <div className="relative group overflow-hidden rounded-[1.5rem] md:rounded-[2.5rem] border-4 md:border-8 border-white bg-zinc-900 shadow-2xl shadow-zinc-200">
                        ...
                        <div className="absolute top-3 left-3 md:top-4 md:left-4 flex gap-2">
                            <Badge className="bg-amber-500 text-white border-none px-2 md:px-3 py-0.5 md:py-1 font-black uppercase text-[8px] md:text-[10px] tracking-widest shadow-lg">
                                Week {weekId}
                            </Badge>
                    ...
                    <Card className="rounded-[1.5rem] md:rounded-[2.5rem] border-zinc-200 shadow-sm overflow-hidden">
                        ...
                        <CardFooter className="bg-zinc-50 border-t border-zinc-100 px-4 md:px-8 py-3 md:py-4 flex justify-between items-center">
                            <span className="text-[10px] md:text-xs text-zinc-400 font-bold flex items-center gap-1 uppercase tracking-widest">
                                <Clock className="w-3 h-3" /> Auto-saved
                            </span>
                            <Button variant="ghost" size="sm" className="text-amber-600 font-black uppercase text-[10px] md:text-[11px] tracking-widest h-auto p-0 hover:bg-transparent">
                                Clear
                            </Button>
                        </CardFooter>
                    </Card>
                ...
                <div className="w-full lg:w-[350px] space-y-8">
                    ...
                    <Card className="rounded-[1.5rem] md:rounded-[2.5rem] border-emerald-100 bg-emerald-50/20 shadow-xl shadow-emerald-100/50 overflow-hidden relative group">
                        ...
                        <CardHeader className="p-6 md:p-8 pb-3 md:pb-4">
                            <CardTitle className="text-emerald-900 font-black uppercase text-[10px] md:text-[11px] tracking-[0.2em]">Completion</CardTitle>
                        </CardHeader>
                    ...
                    <Card className="rounded-[1.5rem] md:rounded-[2.5rem] border-zinc-200 shadow-sm overflow-hidden">
                        <CardHeader className="p-6 md:p-8 pb-3 md:pb-4 border-b border-zinc-50 flex flex-row items-center justify-between">
                            ...
                            <Button variant="ghost" className="h-8 text-[10px] md:text-[11px] font-black uppercase text-amber-600 tracking-widest p-0 h-auto hover:bg-transparent">
                                Get All
                            </Button>
                        </CardHeader>
                    ...
                    <Card className="rounded-[1.5rem] md:rounded-[2.5rem] border-zinc-200 shadow-sm overflow-hidden">
                        <CardHeader className="p-6 md:p-8 pb-3 md:pb-4">
                            <CardTitle className="text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em]">Checklist</CardTitle>
                        </CardHeader>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 py-10 opacity-60 grayscale hover:grayscale-0 transition-all">
                ...
                <Link href="/dashboard/bookings" className="flex items-center gap-2 text-amber-600 font-black uppercase text-xs tracking-widest hover:underline">
